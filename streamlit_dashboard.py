...
def main():
    ...
    if 'search_query' not in st.session_state:
        st.session_state.search_query = "Tata Motors"
    
    user_query = st.sidebar.text_input("Search Query", value=st.session_state.search_query)
    ...
    # Use enhanced query if available, otherwise use session state query
    query = st.session_state.get('enhanced_query', st.session_state.search_query)
    ...
    suggestions = [
        "Strategic", "lithium", "semiconductor", "EV policy", "supply chain", 
